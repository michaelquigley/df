...
func main() {
	...
	user, err := dd.New[User](data, opts)
	if err != nil {
	...
	user2, err := dd.New[User](jsonMap, opts)
	if err != nil {
		fmt.Printf("bind failed: %v\n", err)
		return
	}
	...
	resultData, err := dd.Unbind(user2, opts)
	if err != nil {
	...
	_, err = dd.New[User](invalidData, opts)
	if err != nil {
